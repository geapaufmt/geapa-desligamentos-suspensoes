...
const OFF_CFG = Object.freeze({
  ...
  HEADERS: Object.freeze({
    ...
    DIREITO_HORAS_COMPLEMENTARES: 'DIREITO_HORAS_COMPLEMENTARES',
  ...
  EMAIL: Object.freeze({
    FROM_NAME: 'GEAPA',
    SECRETARY_SUBJECT_PREFIX: 'GEAPA - Pedido aguardando análise',
    DECISION_SUBJECT_PREFIX: 'GEAPA - Atualização da solicitação',
    FINAL_DISMISSAL_SUBJECT: 'GEAPA - Desligamento confirmado',
    FINAL_DISMISSAL_WITH_HOURS_SUBJECT: 'GEAPA - Desligamento confirmado e horas complementares no período',
    FINAL_DISMISSAL_WITHOUT_HOURS_SUBJECT: 'GEAPA - Desligamento confirmado sem horas complementares no período',
    FINAL_DISMISSAL_PENDING_HOURS_SUBJECT: 'GEAPA - Desligamento confirmado com horas complementares pendentes',
  }),
  ...
  ACTIVITIES_FIELDS: Object.freeze({
    PRESENCE_RGA: ['RGA'],
    PRESENCE_SEMESTER: ['SEMESTRE_REFERENCIA', 'SEMESTRE', 'PERIODO_REFERENCIA'],
    PRESENTED_IN_PERIOD: ['APRESENTOU_NO_PERIODO'],
    PRESENTATION_FORECAST: ['PREVISAO_APRESENTACAO_NO_PERIODO'],
    ATTENDANCE_PERCENT: ['PERCENTUAL_FREQUENCIA'],
    TOTAL_ABSENCE_ACTIVITIES: ['TOTAL_ATIVIDADES_QUE_CONTAM_FALTA'],
    ABSENCE_LIMIT: ['LIMITE_FALTAS_PERIODO'],
    NET_ABSENCES: ['FALTAS_LIQUIDAS'],
    LIMIT_USAGE_PERCENT: ['PERCENTUAL_USO_LIMITE'],
    DISCIPLINARY_STATUS: ['SITUACAO_DISCIPLINAR'],
  }),
