...
const OFF_SHEET_UX = Object.freeze({
  ...
  notes: Object.freeze({
    ...
    DISMISSAL: Object.freeze({
      ...
      EMAIL_DECISAO_ENVIADO: 'Marca se o e-mail de decisao ja foi comunicado ao membro.',
      DATA_EMAIL_DECISAO: 'Timestamp do envio do e-mail de decisao.',
      DIREITO_HORAS_COMPLEMENTARES: 'Permite override manual. Use SIM, NAO ou PENDENTE. Quando vazio, o modulo tenta apuracao automatica a partir da base de presencas e atividades.',
  ...
  groups: Object.freeze({
    ...
    DISMISSAL: Object.freeze([
      ...
      { color: '#f4d7f5', headers: ['DECISAO_DIRETORIA', 'DATA_DECISAO', 'OBS_DECISAO', 'STATUS_SOLICITACAO', 'EMAIL_DECISAO_ENVIADO', 'DATA_EMAIL_DECISAO', 'DIREITO_HORAS_COMPLEMENTARES'] },
  ...
  dropdowns: Object.freeze({
    ...
    DISMISSAL: Object.freeze({
      ...
      STATUS_SOLICITACAO: off_buildOffDropdownRule_(['RECEBIDO', 'VALIDADO', 'EM_ANALISE', 'DEFERIDO', 'INDEFERIDO', 'AGUARDANDO_EXECUCAO', 'EXECUTADO', 'CANCELADO', 'ERRO'], 'Estado operacional da solicitacao.'),
      EMAIL_DECISAO_ENVIADO: off_buildOffDropdownRule_(['SIM', 'NAO'], 'Controle do envio do e-mail de decisao.'),
      DIREITO_HORAS_COMPLEMENTARES: off_buildOffDropdownRule_(['SIM', 'NAO', 'PENDENTE'], 'Override manual da variante do e-mail final. Em branco, o modulo tenta apuracao automatica.'),
